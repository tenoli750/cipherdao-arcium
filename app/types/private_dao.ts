...
export type PrivateDao = {
  ...
  "instructions": [
    ...
    {
      "name": "initCastPrivateVoteCompDef",
      "discriminator": [
        153,
        221,
        185,
  ...
  "errors": [
    ...
    {
      "code": 6006,
      "name": "ballotNotInitialized",
      "msg": "The private ballot state is not initialized."
    },
    {
      "code": 6007,
      "name": "ballotAlreadyInitialized",
