...
mod private_vote {
    ...
    #[instruction]
    pub fn init_private_ballot_v2(proposal_id: u64) -> Enc<Mxe, BallotState> {
    ...
    #[instruction]
    pub fn publish_private_tally_v2(state_ctxt: Enc<Mxe, BallotState>) -> PublicTally {
